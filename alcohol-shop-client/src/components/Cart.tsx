...
// const Cart: FunctionComponent<CartProps> = ({ loading, setLoading, quantity, setQuantity, openPaymentModal, setOpenPaymentModal, userInfo, cartData: initialCartData, setCartData }) => {
//     let navigate = useNavigate();
//     let [productsInCart, setProductsInCart] = useState<Product[]>([])
//     // let [cartData, setCartData] = useState<any>();
//     // let [quantity, setQuantity] = useState<Quantity>({});
...
//     let [firstTimeAdded, setFirstTimeAdded] = useState<string[]>([]);
...
//             setProductsInCart(initialCartData)
//     }, [initialCartData])
...
//             .then((res) => {
//                 handleIncrement(product._id)
//                 setProductsInCart((prevProducts: Product[]) => {
//                     let productIndex = prevProducts.findIndex((p) => p._id === product._id)
//                     // let productExists = prevProducts.find((p) => p._id === product._id);

//                     if (productIndex !== -1) {
//                         let updatedProducts = [...prevProducts]
//                         updatedProducts[productIndex].quantity = quantity[product._id as string] || 0;
//                         return updatedProducts
//                     }
//                     // if (!productExists) return [...prevProducts, product];
//                     else return [...prevProducts, product]
...
//                 // addedToCartMsg(` ${product.name} added to cart`);
//                 // if (!quantity.[product._id as string]) {
//                 //     setProductsChanged(true);
//                 //     setFirstTimeAdded([...firstTimeAdded, product._id as string])
//                 // }
//                 // if (!firstTimeAdded.includes(product._id as string)) {
//                 //     setProductsChanged(true);
//                 //     setFirstTimeAdded([...firstTimeAdded, product._id as string])
//                 // }
//                 // getCart()
...
//     let handleIncrement = (productId?: string) => {
//         if (productId) {
//             // setQuantity((prevQuantity: Quantity) => ({ ...prevQuantity, [productId]: (prevQuantity[productId] || 0) + 1, }))
//             setQuantity({ ...quantity, [productId]: (quantity[productId] || 0) + 1, })
